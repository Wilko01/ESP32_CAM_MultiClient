...
const char* ssid = "BerlioZ";
const char* password = "BerLi0Z0";
...
const int FPS = 10; //need to set this in combination with the resolution in rule 419
...
void setup()
{
  ...
  // Frame parameters: pick one and set the correct framerate in rule 80
    config.frame_size = FRAMESIZE_UXGA;  //set the frame rate to max 14
  //config.frame_size = FRAMESIZE_SVGA; ///set the frame rate to 10
  //config.frame_size = FRAMESIZE_VGA; //working smoothly with a framerate of 20
  //config.frame_size = FRAMESIZE_QVGA;
  config.jpeg_quality = 12;
  config.fb_count = 2;

Serial.println("File = ESP32_CAM_MultiClient.ino");
